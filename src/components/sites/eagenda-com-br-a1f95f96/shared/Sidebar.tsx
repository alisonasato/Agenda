...
const PATHS = {
  ...
  tags: "/agendamentos/tags",
  listaEspera: "/agendamentos/listar/espera",
...
const NAV: NavEntry[] = [
  ...
  { kind: "link", label: "Agendamentos", icon: ChecklistIcon, href: ROUTES.agendamentos, keywords: "Listar Agendamentos Agenda" },
  {
    ...
    items: [
      ...
      { label: "Serviços", href: ROUTES.servicos, keywords: "Subserviços Procedimentos", hide: "always" },
      { label: "Tags", href: ROUTES.tags, keywords: "Etiquetas Marcadores", hide: "always" },
      { label: "Listas de Bloqueio", href: ROUTES.listasBloqueio, keywords: "Bloqueios de Datas Supressão", hide: "simple" },
      { label: "Lista de Espera", href: ROUTES.listaEspera, keywords: "Fila de Espera", hide: "always" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Programa de Indicações", href: ROUTES.indicacoes, keywords: "Indique e ganhe Créditos", hide: "simple" },
